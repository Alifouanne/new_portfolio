        ...
        {projectsData.map((project, index) => (
          ...
          >
            <Link href={project.github} target="_blank">
              <section
                className="relative max-w-[42rem] overflow-hidden rounded-lg border border-black/5 bg-gray-100 transition hover:bg-gray-200 dark:border-stone-400/20 dark:bg-[#22222C] dark:hover:bg-[#22222C]/50 sm:h-[20rem] sm:pr-8 sm:group-even:pl-8"
                title={project.alt}
              >
